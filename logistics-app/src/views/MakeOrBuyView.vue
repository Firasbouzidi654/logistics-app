...
import PraxisbeispielMOB   from '../components/makeorbuy/PraxisbeispielMOB.vue'
...
<template>
  <div class="min-h-screen bg-surface-900">
      ...
      <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="flex items-start justify-between flex-wrap gap-4 mb-4">
          ...
          <div class="flex flex-col items-end gap-3">
            ...
            <div v-if="activeTab !== 'praxisbeispiel'" class="flex items-center gap-2">
              <span class="text-xs text-slate-500 hidden sm:inline">Export:</span>
              <ExportPanel type="mob" />
            </div>
          </div>
        </div>

        <!-- Context pills -->
        <div class="flex flex-wrap gap-3 text-sm text-slate-400 mb-5">
          ...
          <div class="flex items-center gap-2 px-3 py-1.5 glass rounded-xl border border-white/8">
            ...
            Break-even · Nutzwertanalyse · Kostenvergleich
          </div>
        </div>
    ...
    <main class="max-w-7xl mx-auto px-6 pb-20">
      ...
      <!-- Always visible: KPI + Decision (hidden on Praxis tab) -->
      <template v-if="activeTab !== 'praxisbeispiel'">
      ...
      <Transition name="tab-slide" mode="out-in">
        ...
        <!-- Kalkulation -->
        <div v-if="activeTab === 'kalkulation'" key="kalkulation" class="space-y-8">
          <MOBInputPanel />

          <!-- Cost detail breakdown -->
          <div class="glass rounded-2xl border border-white/10 p-6 card-lift">
            ...
            <div class="grid md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <!-- Savings highlight -->
                <div :class="[
                  'mt-3 rounded-xl p-3 border text-sm font-semibold text-center transition-all duration-300',
                  store.costDiff >= 0
        ...
        <!-- Kriterienbewertung -->
        <div v-else-if="activeTab === 'kriterien'" key="kriterien">
          <MOBCriteriaTable />
        </div>

        <!-- Kostenanalyse -->
        <div v-else-if="activeTab === 'kostenanalyse'" key="kostenanalyse">
          <MOBCharts />
        </div>

        <!-- Praxisbeispiel -->
        <div v-else key="praxisbeispiel">
          <PraxisbeispielMOB />
        </div>
